...
extern "C" __declspec(dllexport) int __cdecl getFatalErr(void)
{
...
extern "C" __declspec(dllexport) void __cdecl SetRXFileSavePath(char * PathToSaveRXFile)
{
	strcpy(rxfilepath,PathToSaveRXFile);
}
extern "C" __declspec(dllexport) void __cdecl SetRXCorruptSavePath(char * PathToCorruptRXFile)
{
	strcpy(rxcorruptpath,PathToCorruptRXFile);
}
extern "C" __declspec(dllexport) void __cdecl SetBSRPath(char * PathToBSR)
{
...
// Parameters for TX
extern "C" __declspec(dllexport) void __cdecl SetParams(int mode, 
											 int specocc, 
											 int mscprot, 
											 int qam,
											 int interleave)
...
extern "C" __declspec(dllexport) void __cdecl SetCall(char * CallSign)
{
	setcall(CallSign);
	DRMTransmitter.GetParameters()->Service[0].strLabel = getcall();
}

extern "C" __declspec(dllexport) void __cdecl SetDCFreq(int DcFreq)
{
	DRMTransmitter.SetCarOffset(DcFreq);
}

extern "C" __declspec(dllexport) void __cdecl SetStartDelay(int delay)
{
	DRMTransmitter.GetAudSrcEnc()->SetTheStartDelay(delay);
}

// Parameters for RX (call at 400ms intervals max)
extern "C" __declspec(dllexport) boolean __cdecl GetParams(char * mode, 
												char * specocc, 
												char * mscprot, 
												char * qam,
											    char * interleave)
...
extern "C" __declspec(dllexport) boolean __cdecl GetCall(char * CallSign)  // max length 9 char !
{
...
extern "C" __declspec(dllexport) int  __cdecl GetState(int * states)  
{
	PINT statept = states;
	int i;
	for (i=0;i<8;i++)
...
extern "C" __declspec(dllexport) void __cdecl SetCommDevice(int dev)
{
	comtx((char)(dev + '0'));
}
extern "C" __declspec(dllexport) void	 __cdecl SetPTT(int on)
{
	if (on == 0)	endtx();	
	else	dotx();
}
...
extern "C" __declspec(dllexport) int __cdecl GetAudNumDevIn()
{
	return DRMReceiver.GetSoundInterface()->GetNumDevIn();
}
extern "C" __declspec(dllexport) char * __cdecl GetAudDeviceNameIn(int ID)
{
	strcpy(devnam,DRMReceiver.GetSoundInterface()->GetDeviceNameIn(ID).c_str());
	return devnam;
}
extern "C" __declspec(dllexport) void __cdecl SetAudDeviceIn(int ID)
{
	DRMReceiver.GetSoundInterface()->SetInDev(ID);
}

extern "C" __declspec(dllexport) int __cdecl GetAudNumDevOut()
{
	return DRMTransmitter.GetSoundInterface()->GetNumDevOut();
}
extern "C" __declspec(dllexport) char * __cdecl GetAudDeviceNameOut(int ID)
{
	strcpy(devnam,DRMTransmitter.GetSoundInterface()->GetDeviceNameOut(ID).c_str());
	return devnam;
}
extern "C" __declspec(dllexport) void __cdecl SetAudDeviceOut(int ID)
{
...
// File transfer
extern "C" __declspec(dllexport) boolean __cdecl SetFileTX(char * FileName, char * Dir_and_FileName, int inst)  
{
	CVector<short> dummy;
...
// Send BSR
extern "C" __declspec(dllexport) boolean __cdecl SendBSR(int inst, int fast)  
{
	CVector<short> dummy;
	char filenam[300];
	char filenam2[300];
...
extern "C" __declspec(dllexport) boolean __cdecl GetFileRX(char * FileName)  
{
	CMOTObject NewPic;
...
extern "C" __declspec(dllexport) int __cdecl GetLastTID()
{
	return iTID;
}
...
extern "C" __declspec(dllexport) boolean __cdecl GetPercentTX(int * piccnt,int * percent)
{
	if (TX_Sending)
	{
...
extern "C" __declspec(dllexport) void __cdecl GetSegPosTX(int * tot, int * act)
{
...
// Threads
extern "C" __declspec(dllexport) void __cdecl StartThreadRX(int AudDev)
{
	try
	{
		DRMReceiver.Init();
...
extern "C" __declspec(dllexport) void __cdecl StartThreadTX(int AudDev)
{
	try
	{
		DRMTransmitter.Init();
...
extern "C" __declspec(dllexport) void __cdecl StopThreads()  
{
	DRMReceiver.Stop(); 
	DRMTransmitter.Stop();
	TX_Sending = FALSE;
...
extern "C" __declspec(dllexport) void __cdecl ControlRX(boolean SetON)
{
	if (SetON)
	{
...
extern "C" __declspec(dllexport) void __cdecl ControlTX(boolean SetON)
{
	if (SetON)
	{
		if (callisok())
...
extern "C" __declspec(dllexport) int  __cdecl GetSpectrum(float * data) // 500 bins
{
...
extern "C" __declspec(dllexport) int  __cdecl GetSPSD(float * data)
{
...
extern "C" __declspec(dllexport) int  __cdecl GetTF(float * data, float * gddata)
{
	PFLOAT farr1 = data;
	PFLOAT farr2 = gddata;
...
extern "C" __declspec(dllexport) int  __cdecl GetIR(float*lb,float*hb,float*sg,float*eg,float*pb,float*pe,float*data)
{
...
extern "C" __declspec(dllexport) int  __cdecl GetFAC(float * datax,float * datay)
{
	PFLOAT farr1 = datax;
	PFLOAT farr2 = datay;
...
extern "C" __declspec(dllexport) int  __cdecl GetMSC(float * datax,float * datay)
{
	PFLOAT farr1 = datax;
	PFLOAT farr2 = datay;
...
extern "C" __declspec(dllexport) int  __cdecl GetSNR()
{
	if (RX_Running)
...
extern "C" __declspec(dllexport) int  __cdecl GetLevel()
{
	return (int)(DRMReceiver.GetReceiver()->GetLevelMeter() * 100.0);
}

extern "C" __declspec(dllexport) int  __cdecl GetDCFreq()
{
...
extern "C" __declspec(dllexport) boolean __cdecl GetBSR(int * numbsrsegments, char * namebsrfile)
{
	int numseg;
	string bsrname;
...
extern "C" __declspec(dllexport) boolean __cdecl readthebsrfile(char * fnam,int * segno)
{
...
extern "C" __declspec(dllexport) void   __cdecl writebsrselsegments(int inst)
{
	writeselsegments(inst);
}

extern "C" __declspec(dllexport) void __cdecl GetData(int * totsize,int * actsize,int * actpos)
{
...
extern "C" __declspec(dllexport) boolean __cdecl GetCorruptFileRX(char * FileName)
{
	CMOTObject NewPic;
...
extern "C" __declspec(dllexport) boolean __cdecl GetActSegm(char * data)
{
...
extern "C" __declspec(dllexport) void __cdecl ResetRX(void)
{
	DRMReceiver.SetInStartMode();
}
