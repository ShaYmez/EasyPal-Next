								   ...
								   CBuffer<TOutput>& OutputBuffer)
{
	...
	if (iMaxOutputBlockSize != 0)
		...
		if (this->iOutputBlockSize != 0)
			OutputBuffer.Init(this->iOutputBlockSize);
}
...
CTransmitterModul<TInput, TOutput>::CTransmitterModul()
{
	...
	this->iInputBlockSize2 = 0;
	this->pvecInputData2 = NULL;
}
...
CReceiverModul<TInput, TOutput>::CReceiverModul()
{
	...
	this->iOutputBlockSize2 = 0;
	this->iOutputBlockSize3 = 0;
	this->pvecOutputData2 = NULL;
	this->pvecOutputData3 = NULL;
	bResetBuf = FALSE;
	bResetBuf2 = FALSE;
	bResetBuf3 = FALSE;
	bDoInit = FALSE;
									  ...
									  CBuffer<TOutput>& OutputBuffer2)
{
	...
	if (iMaxOutputBlockSize2 != 0)
		...
		if (this->iOutputBlockSize2 != 0)
			OutputBuffer2.Init(this->iOutputBlockSize2);
}
									  ...
									  CBuffer<TOutput>& OutputBuffer3)
{
	...
	if (iMaxOutputBlockSize3 != 0)
		...
		if (this->iOutputBlockSize3 != 0)
			OutputBuffer3.Init(this->iOutputBlockSize3);
}
				...
				CBuffer<TOutput>& OutputBuffer3)
{
	...
	if (InputBuffer.GetFillLevel() >= this->iInputBlockSize)
	{
		...
		OutputBuffer.Put(this->iOutputBlockSize);
		OutputBuffer2.Put(this->iOutputBlockSize2);
		OutputBuffer3.Put(this->iOutputBlockSize3);
